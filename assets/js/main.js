 ...
 */ !(function (t) {
  ...
  function (t, e, n) {
    ...
    (r.env.safari = /safari/.test(g) && !I && !y),
      m &&
  ...
  function (t, e, n) {
    ...
    e.previewRequested = function (t) {
      var e = t.rawData,
        n = t.defer;
      return { type: f, payload: { defer: n, rawData: e } };
    };
    ...
    window.tram = (function (t) {
      ...
      var Y = t.style,
        ...
        Q = {
          ...
          "border-width": [j, I],
          "border-top-width": [j, I],
          "border-right-width": [j, I],
          "border-bottom-width": [j, I],
          "border-left-width": [j, I],
          "border-spacing": [j, I],
          "letter-spacing": [j, I],
          margin: [j, I],
          "margin-top": [j, I],
  ...
  function (t, e, n) {
    ...
    function ot(t, e) {
      var n = t.rawData,
        r = function () {
          ft({ store: e, rawData: n, allowEvents: !0 }), at();
        };
    ...
    function mt(t) {
      ...
      if (l && l.useFirstGroupAsInitialState) {
        ...
        f.forEach(function (t) {
          var i = t.config,
            o = t.actionTypeId,
            a = M({ config: i, event: c, elementApi: I }),
            u = J(o);
          a.forEach(function (i) {
            var a = u ? tt(o)(i, t) : null;
            Ot({
              destination: G({ element: i, actionItem: t, elementApi: I }, a),
              immediate: !0,
              store: e,
              element: i,
              eventId: r,
    ...
    function yt(t) {
      var e = t.store,
        ...
        u = a.ixInstances,
        c =
          a.ixSession.hasBoundaryNodes && r ? I.getClosestElement(r, b) : null;
          ...
          if (p) {
            ...
            M({
              ...
              var E = w === a && 0 === p,
                ...
                g = G({ element: s, actionItem: t, elementApi: I }, v);
              Ot({
                store: e,
                element: s,
                actionItem: t,
    ...
    function Ot(t) {
      ...
      e.dispatch(
        (0, m.instanceAdded)(
          (0, a.default)(
            { instanceId: f, elementId: h, origin: g, refType: _ },
            r
          )
        )
      ),
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, E, _, g) {
      ...
      if (A && !O)
        return (
          g || (g = new r()),
          m || l(t) ? i(t, e, n, E, _, g) : o(t, e, y, n, E, _, g)
        );
      if (!(n & f)) {
  ...
  function (t, e, n) {
      ...
      (e.getInstanceOrigin = function (t) {
        ...
        switch (o) {
          ...
          case I.STYLE_OPACITY:
            return { value: (0, l.default)(parseFloat(i(t, g.OPACITY)), 1) };
          case I.STYLE_SIZE:
            var u,
              c,
              s = i(t, g.WIDTH),
          ...
          case I.GENERAL_DISPLAY:
            return { value: (0, l.default)(i(t, g.DISPLAY), n.display) };
          case I.OBJECT_VALUE:
            return e[o] || { value: 0 };
          default:
            return;
        ...
        switch (i) {
          ...
          case I.STYLE_TEXT_COLOR:
            var w = n.config,
              ...
              b = w.bValue,
              R = w.aValue;
            return { rValue: A, gValue: S, bValue: b, aValue: R };
          case I.STYLE_FILTER:
          ...
          case g.RENDER_TRANSFORM:
            return (function (t, e, n, r, i) {
              ...
              X(t, y.TRANSFORM_PREFIXED, i),
                ...
                (f = c.yValue),
                (d = c.zValue),
                ((s === I.TRANSFORM_MOVE && void 0 !== d) ||
                  (s === I.TRANSFORM_SCALE && void 0 !== d) ||
                  (s === I.TRANSFORM_ROTATE &&
                    (void 0 !== l || void 0 !== f))) &&
                ...
                case I.STYLE_TEXT_COLOR:
                  ...
                  X(t, _, o),
                    a(
                      ...
                      _,
                      w >= 1
                        ? "rgb(".concat(m, ",").concat(y, ",").concat(T, ")")
                        : "rgba("
                            .concat(m, ",")
                            .concat(y, ",")
                            .concat(T, ",")
    ...
    var l = s(n(194)),
      ...
      O = Object.freeze(
        ((r = {}),
        (0, c.default)(r, I.STYLE_BACKGROUND_COLOR, g.BACKGROUND_COLOR),
        (0, c.default)(r, I.STYLE_BORDER, g.BORDER_COLOR),
        (0, c.default)(r, I.STYLE_TEXT_COLOR, g.COLOR),
        r)
      ),
      w = Object.freeze(
        ((i = {}),
    ...
    function C(t) {
      ...
      var R,
        ...
        L,
        x =
          (0, p.default)(n, "action.config.affectedElements", {})[_ || T] || {},
        D = Boolean(x.id || x.selector),
        P = n && u(N(n.target));
      if (
        (D
          ? ((R = x.limitAffectedElements), (C = P), (L = u(x)))
          : (C = L = u({ id: _, selector: T, selectorGuids: O })),
        n && S)
      ) {
        var M = r && (L || !0 === S) ? [r] : c(P);
        if (L) {
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n) {
      ...
      return (
        ...
        r(n) &&
          ((E = !!n.leading),
          (f = (_ = "maxWait" in n) ? u(o(n.maxWait) || 0, e) : f),
  ...
  function (t, e, n) {
    ...
    var c,
      ...
      it = { handler: rt(tt, nt) },
      ot = (0, f.default)({}, it, { types: [F, G].join(" ") }),
      at = [
      ...
      mt =
        ...
        (0, o.default)(r, y, (0, f.default)({}, it, { types: "mousedown" })),
        ...
        (0, o.default)(r, D, {
          ...
          handler: function (t) {
            ...
            return (
              ...
              { elementHovered: S, clientX: v, clientY: _, pageX: m, pageY: y }
            );
          },
        }),
        (0, o.default)(r, H, {
        ...
        (0, o.default)(r, V, {
          ...
          handler: function (t) {
            ...
            if (d === z) {
              ...
              return (
                w !== o.scrollPercent &&
                  n.dispatch((0, E.parameterChanged)(v, w)),
                { scrollPercent: w }
              );
            }
            var A = q(i, v),
              ...
              R = (g ? O : 0) / 100;
            (b = h ? b : 1 - b), (R = _ ? R : 1 - R);
            var N = S.top + Math.min(S.height * b, f),
              C = S.top + S.height * R - N,
              L = Math.min(f + C, l),
              x = Math.min(Math.max(0, f - N), L) / L;
            return (
              x !== o.scrollPercent &&
                n.dispatch((0, E.parameterChanged)(A, x)),
              { scrollPercent: x }
            );
          },
        }),
    ...
    t.exports = function (t) {
      return i(function (e) {
        ...
        for (i = E ? i : n; ++i < n; ) {
          ...
          E =
            g && c(g[0]) && g[1] == (d | l | f | p) && !g[4].length && 1 == g[9]
              ? E[a(g[0])].apply(E, g[3])
              : 1 == h.length && c(h)
              ? E[_]()
              : E.thru(h);
    ...
    r.define(
      ...
      (t.exports = function (t, e) {
        ...
        function I(n, i) {
          ...
          c.attr("role", "menu"),
            c.on("keydown", b),
            E || ((E = "w-dropdown-list-" + n), f.list.attr("id", E)),
            c.on(
              "keyup",
              (function (t) {
                return function (e) {
                    ...
                    switch (e.keyCode) {
                      ...
                      case o.ARROW_DOWN:
                        return (
                          ...
                          void (
                            t.selectedIdx >= 0 &&
                            (t.open || (t.selectedIdx = 0), w(t), S(t))
                          )
                        );
                      case o.ARROW_UP:
                        return (
            ...
            _ || ((_ = "w-dropdown-toggle-" + n), f.toggle.attr("id", _)),
      ...
      (t.exports = function (t, e) {
        ...
        function I(e, n) {
          ...
          (i.handler = null),
            ...
            g.test(u) ? (i.handler = A) : u || (o ? (i.handler = w) : m());
        }
        function y(t) {
    ...
    function s(t, e, n, r) {
      ...
      (E.build = function () {
        return (
          ...
          s.strip.on("click", C("item"), y),
          s.content
            .on("swipe", T)
            .on("click", C("left"), g)
            .on("click", C("right"), m)
            .on("click", C("close"), I)
            .on("click", C("image, caption"), m),
          s.container.on("click", C("view"), I).on("dragstart", C("img"), w),
                ...
                function (r) {
                  if (t === o) {
                    var i,
                      ...
                      E = P("view").append(p);
                    e.html &&
                      ((a = (i = n(e.html)).is("iframe")) && i.on("load", _),
                      d.append(L(i, "embed"))),
                      e.caption &&
        ...
        (E.hide = function () {
          return (
            f(s.lightbox).add("opacity .3s").start({ opacity: 0 }).then(S), E
          );
        }),
        (E.prev = function () {
          var t = u(o - 1, h);
      ...
      (t.exports = function (t, e) {
        ...
        function h() {
          (n = l.find(d)).length &&
            (n.each(g),
            (u = null),
            a || (E(), r.resize.on(_), r.redraw.on(c.redraw)));
        }
        function E() {
        ...
        function g(e, n) {
          ...
          i.el.off(d),
            ...
            m(i),
            o
              ? (i.el.on("setting" + d, w(i)), O(i), (i.hasTimer = !1))
              : (i.el.on("swipe" + d, w(i)),
        ...
        function m(t) {
          ...
          if (
            ...
            I(t.el.attr("data-infinite")) && (e.infinite = !0),
            I(t.el.attr("data-disable-swipe")) && (e.disableSwipe = !0),
            I(t.el.attr("data-hide-arrows"))
              ? (e.hideArrows = !0)
        ...
        function A(e, n) {
          ...
          var f = e.offsetX || 0,
            ...
            T = "opacity " + I + "ms " + m,
            O = "transform " + I + "ms " + m;
          if ((o || (h.each(v.intro), _.each(v.outro)), n.immediate && !u))
  ...
  events: {
    e: {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "f26fcb3f-b85c-97e9-9d10-8d389f79b6e0",
      },
      config: {
        loop: false,
        playInReverse: false,
    ...
    "e-3": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "febc65da-9a33-e255-19d1-14c873077c69",
      },
      config: {
        loop: false,
        playInReverse: false,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["a0fff80a-57ad-3201-768d-1e5a8a4544e6"],
                },
                value: 0,
                unit: "",
              },
